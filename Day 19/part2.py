    ...
    for scanner in scanners:
        for main in transformed:
            ...
            if len(overlap) >= 12:
                ...
                scanner_locations.append((int(translation[0]), int(translation[1]), int(translation[2])))
...
distances = []
for point1 in scanner_locations:
    for point2 in [point for point in scanner_locations if point != point1]:
        distances.append(sum(abs(val1-val2) for val1, val2 in zip(list(point1),list(point2))))
